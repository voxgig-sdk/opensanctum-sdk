...
type TraditionEntity struct {
	name    string
	client  *core.OpensanctumSDK
...
func NewTraditionEntity(client *core.OpensanctumSDK, entopts map[string]any) *TraditionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TraditionEntity) GetName() string { return e.name }
...
func (e *TraditionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TraditionEntity) Deleted() bool {
	return e.deleted
}


func (e *TraditionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTraditionEntity(e.client, opts)
}

func (e *TraditionEntity) Data(args ...any) any {
...
func (e *TraditionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tradition; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TraditionEntity) DataTyped(data ...Tradition) Tradition {
	if len(data) > 0 {
		return typedFrom[Tradition](e.Data(asMap(data[0])))
	}
	return typedFrom[Tradition](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tradition (all fields
// optional at the wire level).
func (e *TraditionEntity) MatchTyped(match ...Tradition) Tradition {
	if len(match) > 0 {
		return typedFrom[Tradition](e.Match(asMap(match[0])))
	}
	return typedFrom[Tradition](e.Match())
}
...
func (e *TraditionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TraditionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TraditionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TraditionListMatch and returns []Tradition. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TraditionEntity) ListTyped(reqmatch TraditionListMatch, ctrl map[string]any) ([]Tradition, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Tradition](res), nil
}



func (e *TraditionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TraditionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TraditionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TraditionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
