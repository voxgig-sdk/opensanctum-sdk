...
const testSeed = `map[string]any{"entity": map[string]any{"place": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tradition": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
