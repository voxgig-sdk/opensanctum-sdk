...
place, err := client.Place(nil).Load(
    map[string]any{"id": "test01"}, nil,
)
if err != nil {
    panic(err)
}
fmt.Println(place) // the loaded mock data
```
...
slice):
    ...
    place, err := client.Place(nil).Load(map[string]any{"id": "example_id"}, nil)
    if err != nil { /* handle */ }
...
place.Load(map[string]any{"id": "example_id"}, nil)
