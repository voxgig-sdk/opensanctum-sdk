...
The Golang SDK for the Opensanctum API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/opensanctum-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/opensanctum-sdk=../path/to/github.com/voxgig-sdk/opensanctum-sdk
```
...
```
github.com/voxgig-sdk/opensanctum-sdk/
...
The root package (`github.com/voxgig-sdk/opensanctum-sdk`) re-exports everything needed
