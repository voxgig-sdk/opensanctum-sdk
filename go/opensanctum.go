...
// instead of `sdk.NewOpensanctumSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpensanctumSDK  { return NewOpensanctumSDK(nil) }
func Test() *OpensanctumSDK { return TestSDK(nil, nil) }
