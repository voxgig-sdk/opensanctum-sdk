...
func (sdk *OpensanctumSDK) OptionsMap() map[string]any {
...
func (sdk *OpensanctumSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpensanctumSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpensanctumSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpensanctumSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpensanctumSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpensanctumSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpensanctumSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpensanctumSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpensanctumSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpensanctumSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
