...
// Opensanctum SDK telemetry feature
...
class OpensanctumTelemetryFeature extends OpensanctumBaseFeature
{
    ...
    private function _close(OpensanctumContext $ctx, bool $ok): void
    {
