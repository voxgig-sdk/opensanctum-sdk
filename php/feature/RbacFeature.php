...
class OpensanctumRbacFeature extends OpensanctumBaseFeature
{
    ...
    private function _required(OpensanctumContext $ctx): ?string
    {
    ...
    private function _reject(OpensanctumContext $ctx, string $required): void
    {
    ...
    private function _track(OpensanctumContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
