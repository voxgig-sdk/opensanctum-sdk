...
// Opensanctum SDK streaming feature
...
class OpensanctumStreamingFeature extends OpensanctumBaseFeature
{
    ...
    private function _iterate(OpensanctumResult $result): \Generator
    {
    ...
    private function _streamable(OpensanctumContext $ctx): bool
    {
