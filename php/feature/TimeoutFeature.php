...
// Opensanctum SDK timeout feature
...
class OpensanctumTimeoutFeature extends OpensanctumBaseFeature
{
    ...
    private function _with_timeout(OpensanctumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpensanctumContext $_ctx, float $ms): void
    {
        $client = $this->client;
