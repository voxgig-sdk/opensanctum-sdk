...
// Opensanctum SDK clienttrack feature
...
class OpensanctumClienttrackFeature extends OpensanctumBaseFeature
{
    ...
    public function PostConstruct(OpensanctumContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Opensanctum-SDK';
