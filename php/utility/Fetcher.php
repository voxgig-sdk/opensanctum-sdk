...
// Opensanctum SDK utility: fetcher

class OpensanctumFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpensanctumSDK/1.0)';
    ...
    public static function call(OpensanctumContext $ctx, string $fullurl, array $fetchdef): array
    {
