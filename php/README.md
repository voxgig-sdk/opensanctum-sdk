...
The PHP SDK for the Opensanctum API — an entity-oriented client using PHP conventions.
...
```
php/
├── opensanctum_sdk.php          -- Main SDK class
...
The main class (`opensanctum_sdk.php`) exports the SDK class
