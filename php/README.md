...
The PHP SDK for the Opensanctum API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Place(null)->list(null, null);
...
[$result, $err] = $client->Opensanctum(null)->load(
    ["id" => "test01"], null
);
