...
class OpensanctumTestRunner
{
    ...
    {
        $live = self::getenv('OPENSANCTUM_TEST_LIVE');
        $override = self::getenv('OPENSANCTUM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPENSANCTUM_TEST_EXPLAIN');
...
class_alias('OpensanctumTestRunner', 'Runner');
class_alias('OpensanctumHelpers', 'Helpers');
