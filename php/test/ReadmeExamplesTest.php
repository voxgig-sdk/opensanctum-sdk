...
// Opensanctum SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpensanctumSDK::test)
...
{
    private const SDK_CLASS = 'OpensanctumSDK';
    ...
    private const SDK_BASE = 'opensanctum_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../opensanctum_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
