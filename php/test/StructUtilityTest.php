...
// Opensanctum SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OpensanctumOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OpensanctumOmni::structfix($now, Struct::undef()))
                        !== json_encode(OpensanctumOmni::structfix($val, Struct::undef()))) {
