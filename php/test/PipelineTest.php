...
{
    private static function utility(): OpensanctumUtility
    {
        return new OpensanctumUtility();
    }
    ...
    private static function ctx(array $over = []): OpensanctumContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OpensanctumContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OpensanctumOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OpensanctumError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OpensanctumOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OpensanctumMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OpensanctumOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OpensanctumMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OpensanctumOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OpensanctumMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OpensanctumSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OpensanctumMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OpensanctumResponse([]),
            'result' => new OpensanctumResult([]),
        ]);
        [, $err] = OpensanctumMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OpensanctumSpec([]),
            'response' => null,
            'result' => new OpensanctumResult([]),
        ]);
        [, $err] = OpensanctumMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OpensanctumSpec(['step' => 's']),
            'response' => new OpensanctumResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OpensanctumResult([]),
        ]);
        [, $err] = OpensanctumMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OpensanctumSpec(['step' => 's']),
            'response' => new OpensanctumResponse(self::resp(200, ['v' => 1])),
            'result' => new OpensanctumResult([]),
        ]);
        [, $err] = OpensanctumMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OpensanctumSpec(['step' => 's']),
            'response' => new OpensanctumResponse(self::resp(200, ['v' => 2])),
            'result' => new OpensanctumResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OpensanctumMakeResponse::call($ctx);
    ...
    {
        $preset = new OpensanctumResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OpensanctumSpec([]),
            'response' => new OpensanctumResponse([]),
            'result' => new OpensanctumResult([]),
        ...
        [$got, $err] = OpensanctumMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OpensanctumResult([])]);
        [, $err] = OpensanctumMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OpensanctumSpec([]), 'result' => null]);
        [, $err] = OpensanctumMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OpensanctumSpec(['step' => 's']),
            'result' => new OpensanctumResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OpensanctumOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OpensanctumMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OpensanctumSpec(['step' => 's']),
            'result' => new OpensanctumResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OpensanctumOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OpensanctumMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OpensanctumResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OpensanctumSpec([]),
            'result' => new OpensanctumResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OpensanctumMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OpensanctumMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OpensanctumError('boom', 'boom');
        $utility->fetcher = function (OpensanctumContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OpensanctumSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OpensanctumMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OpensanctumContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OpensanctumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OpensanctumResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        OpensanctumMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OpensanctumContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OpensanctumSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OpensanctumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OpensanctumResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OpensanctumSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OpensanctumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OpensanctumMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OpensanctumMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OpensanctumResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OpensanctumDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OpensanctumResult(['ok' => false])]);
        $this->expectException(OpensanctumError::class);
        OpensanctumDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OpensanctumResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OpensanctumMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OpensanctumMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OpensanctumBaseFeature();
        $b = new OpensanctumBaseFeature();
        OpensanctumFeatureAdd::call($ctx, $a);
        OpensanctumFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OpensanctumBaseFeature
    {
        $f = new OpensanctumBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OpensanctumFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OpensanctumContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OpensanctumSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OpensanctumPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        OpensanctumPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OpensanctumResponse(['headers' => null]),
            'result' => new OpensanctumResult([]),
        ]);
        OpensanctumResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        OpensanctumResultBody::call($ctx);
