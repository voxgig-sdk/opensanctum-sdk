...
class TraditionEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = OpensanctumSDK::test($seed, null);
        $seen = iterator_to_array($base->Tradition(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Tradition(null)->stream("list", null, null) as $item) {
