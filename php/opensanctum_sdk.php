...
class OpensanctumSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = OpensanctumHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = OpensanctumHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!OpensanctumFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, OpensanctumFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return OpensanctumUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = OpensanctumHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = OpensanctumHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = OpensanctumHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new OpensanctumError($op . "_allow",
                "OpensanctumSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = OpensanctumHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new OpensanctumError("graphql_error",
                "OpensanctumSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Tradition($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_tradition === null) {
                $this->_tradition = new TraditionEntity($this, null);
            }
            return $this->_tradition;
        }
        return new TraditionEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new OpensanctumSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
