...
local OpensanctumSDK = {}
OpensanctumSDK.__index = OpensanctumSDK
...
OpensanctumSDK._make_feature = _make_feature


function OpensanctumSDK.new(options)
  local self = setmetatable({}, OpensanctumSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OpensanctumSDK:options_map()
...
function OpensanctumSDK:get_utility()
  return Utility.copy(self._utility)
end


function OpensanctumSDK:get_root_ctx()
  return self._rootctx
end


function OpensanctumSDK:prepare(fetchargs)
...
function OpensanctumSDK:direct(fetchargs)
...
-- by passing it.
function OpensanctumSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OpensanctumSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "OpensanctumSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function OpensanctumSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = OpensanctumSDK.new(sdkopts)
  sdk.mode = "test"
