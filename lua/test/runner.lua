...
function runner.env_override(m)
  local live = runner.getenv("OPENSANCTUM_TEST_LIVE")
  local override = runner.getenv("OPENSANCTUM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENSANCTUM_TEST_EXPLAIN")
