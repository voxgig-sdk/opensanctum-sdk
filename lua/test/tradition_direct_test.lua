...
describe("TraditionDirect", function()
  it("should direct-list-tradition", function()
    local setup = tradition_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tradition", setup.live and "live" or "unit")
