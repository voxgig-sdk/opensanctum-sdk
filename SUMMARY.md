...
Results: Successful response with list of places.
...
Results: Successful response with list of traditions.
...
| Tradition | `list` | `GET /traditions` | See reference |

## Connect to the API

- Production server: `https://www.opensanctum.com/api`
...
- `opensanctum_list`: List records for an entity. Supported entities: `place`, `tradition`.
- `opensanctum_load`: Load one record for an entity. No active entity supports this operation.
