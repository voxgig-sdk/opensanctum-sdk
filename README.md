...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/opensanctum` | `npm install @voxgig-sdk/opensanctum` |
| Python | `voxgig-sdk-opensanctum` | `pip install voxgig-sdk-opensanctum` |
| PHP | `voxgig-sdk/opensanctum` | `composer require voxgig-sdk/opensanctum` |
| Golang | `github.com/voxgig-sdk/opensanctum-sdk/go` | `go get github.com/voxgig-sdk/opensanctum-sdk/go` |
| Ruby | `voxgig-sdk-opensanctum` | `gem install voxgig-sdk-opensanctum` |
| Lua | `voxgig-sdk-opensanctum` | `luarocks install voxgig-sdk-opensanctum` |
