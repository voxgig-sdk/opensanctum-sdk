...
module OpensanctumTestRunner
  ...
  def self.env_override(m)
    live = getenv("OPENSANCTUM_TEST_LIVE")
    override = getenv("OPENSANCTUM_TEST_OVERRIDE")
    ...
    explain = getenv("OPENSANCTUM_TEST_EXPLAIN")
    m["OPENSANCTUM_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = OpensanctumTestRunner
Helpers = OpensanctumHelpers
Vs = VoxgigStruct
