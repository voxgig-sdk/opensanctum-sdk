...
func registerSDKWords(r *eng.Registry, client *sdk.OpensanctumSDK) {
...
func runOp(client *sdk.OpensanctumSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
