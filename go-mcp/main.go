// Command Opensanctum-mcp is an MCP server exposing the Opensanctum
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Opensanctum_list  — list records of an entity
//	Opensanctum_load  — load a single record of an entity
//
