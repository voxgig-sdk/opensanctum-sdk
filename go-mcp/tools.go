...
type Args struct {
	Entity string         `json:"entity" jsonschema:"place | tradition"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpensanctumSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "opensanctum_list",
		Description: "List records from Opensanctum. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "opensanctum_load",
		Description: "Load a single record from Opensanctum. " +
...
func runOp(client *sdk.OpensanctumSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpensanctumSDK, name string) (sdk.OpensanctumEntity, error) {
	switch strings.ToLower(name) {
	case "place":
		return client.Place(nil), nil
	case "tradition":
		return client.Tradition(nil), nil
