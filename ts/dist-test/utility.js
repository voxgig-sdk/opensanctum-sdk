...
function envOverride(m) {
    if ('TRUE' === process.env.OPENSANCTUM_TEST_LIVE ||
        'TRUE' === process.env.OPENSANCTUM_TEST_OVERRIDE) {
    ...
    m.OPENSANCTUM_TEST_EXPLAIN = process.env.OPENSANCTUM_TEST_EXPLAIN || m.OPENSANCTUM_TEST_EXPLAIN;
    return m;
}
