...
(0, node_test_1.describe)('TraditionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpensanctumSDK({
    ...
    (0, node_test_1.test)('direct-list-tradition', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tradition', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.OPENSANCTUM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpensanctumSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['OPENSANCTUM_TEST_TRADITION_ENTID'];
    ...
    const client = new __1.OpensanctumSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TraditionDirect.test.js.map