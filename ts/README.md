# Opensanctum TypeScript SDK



The TypeScript SDK for the Opensanctum API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Place()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `OpensanctumSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `OpensanctumSDK.test(testopts?, sdkopts?)` | `OpensanctumSDK` | Create a test-mode client. |
...
| `client` | `client(): OpensanctumSDK` | Return the parent SDK client. |
...
opensanctum/
├── src/
│   ├── OpensanctumSDK.ts        # Main SDK class
