...
exports.OpensanctumEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends OpensanctumEntityBase<Advice>`.
class OpensanctumEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.OpensanctumEntityBase = OpensanctumEntityBase;
//# sourceMappingURL=OpensanctumEntityBase.js.map