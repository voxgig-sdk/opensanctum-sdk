...
|---|---|---|
| `ts/` | @voxgig-sdk/opensanctum-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/opensanctum-sdk \
      --repository voxgig-sdk/opensanctum-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/opensanctum-sdk` shows it, and
`npm trust revoke @voxgig-sdk/opensanctum-sdk --id=<id>` removes it.
