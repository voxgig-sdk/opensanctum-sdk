...
from projectname_sdk.core.control import OpensanctumControl
...
class OpensanctumContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, OpensanctumSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OpensanctumResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OpensanctumResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OpensanctumError(code, msg, self)
