# Opensanctum SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, OpensanctumError):
        errmsg = err.msg
    ...
    msg = "OpensanctumSDK: " + opname + ": " + errmsg
    ...
    sdk_err = OpensanctumError("", msg, ctx)
