...
// Opensanctum SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OpensanctumTransformResponse
{
    public static function call(OpensanctumContext $ctx): mixed
    {
        ...
        $transform = OpensanctumHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
