...
// Opensanctum SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpensanctumMakeRequest
{
    public static function call(OpensanctumContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpensanctumResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpensanctumResponse($fetched);
        } else {
