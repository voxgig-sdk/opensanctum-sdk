...
// Opensanctum SDK utility: graphql
//
...
class OpensanctumGraphql
{
    ...
    // equivalent.
    public static function body(OpensanctumContext $ctx): mixed
    {
    ...
    public static function errors(OpensanctumContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
