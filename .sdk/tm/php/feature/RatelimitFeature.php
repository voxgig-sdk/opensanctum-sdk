...
// Opensanctum SDK ratelimit feature
...
class OpensanctumRatelimitFeature extends OpensanctumBaseFeature
{
    ...
    private function _acquire(OpensanctumContext $ctx): void
    {
    ...
    private function _track(OpensanctumContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
