...
// Opensanctum SDK netsim feature
...
class OpensanctumNetsimFeature extends OpensanctumBaseFeature
{
    ...
    private function _simulate(OpensanctumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpensanctumContext $ctx, array $applied): void
    {
        $client = $this->client;
