...
// Opensanctum SDK idempotency feature
...
class OpensanctumIdempotencyFeature extends OpensanctumBaseFeature
{
    ...
    private function _mutating(OpensanctumContext $ctx): bool
    {
