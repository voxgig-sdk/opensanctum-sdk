...
// Opensanctum SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class OpensanctumTestFeature extends OpensanctumBaseFeature
{
    ...
    public function init(OpensanctumContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OpensanctumContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = OpensanctumParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OpensanctumContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OpensanctumContext $ctx, $op, $args): array
    {
