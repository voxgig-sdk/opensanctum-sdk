...
class OpensanctumCacheFeature extends OpensanctumBaseFeature
{
    ...
    private function _through(OpensanctumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
