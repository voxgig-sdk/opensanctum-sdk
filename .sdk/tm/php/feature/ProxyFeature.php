...
class OpensanctumProxyFeature extends OpensanctumBaseFeature
{
    ...
    public function init(OpensanctumContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpensanctumContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
