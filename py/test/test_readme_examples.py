# Opensanctum SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpensanctumSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpensanctumSDK(...) and OpensanctumSDK.test(...) become
#      OpensanctumSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "opensanctum_sdk"
_SDK_CLASS = "OpensanctumSDK"
