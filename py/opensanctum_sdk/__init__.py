...
from opensanctum_sdk.utility import register

# Load features
from opensanctum_sdk.feature.base_feature import OpensanctumBaseFeature
from opensanctum_sdk.features import _has_feature, _make_feature
...
class OpensanctumSDK:
    ...
    def get_utility(self):
        return OpensanctumUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpensanctumSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Place(self, data=None) -> "PlaceEntity":
        ...
        from opensanctum_sdk.entity.place_entity import PlaceEntity
    ...
    def Tradition(self, data=None) -> "TraditionEntity":
        ...
        from opensanctum_sdk.entity.tradition_entity import TraditionEntity
